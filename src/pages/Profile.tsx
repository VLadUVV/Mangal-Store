...
export default function Profile() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch("http://mangal-store.ru:3500/api/login", {
        method: "POST",
  ...
  const handleRegister = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch("http://mangal-store.ru:3500/api/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://mangal-store.ru:3500/api/profile", {
        method: "POST", 
        headers: { "Content-Type": "application/json" },
